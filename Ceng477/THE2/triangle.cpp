...
namespace fst
{
    Triangle::Triangle(const math::Vector3f& v0, const math::Vector3f& edge1, const math::Vector3f& edge2, int index0,int index1, int index2, int givenTextureID)
        : m_v0(v0)
        , m_edge1(edge1)
        , m_edge2(edge2)
        , m_normal(math::normalize(math::cross(edge1, edge2)))
        , edge0_textIndex(index0)
        , edge1_textIndex(index1)
        , edge2_textIndex(index2)
        , textureID(givenTextureID)
    {}
