...
void initTexture(char *height_map_file, char *texture_map_file, int *w, int *h)
{
    ...
    glSamplerParameteri(mySampler, GL_TEXTURE_MAG_FILTER, GL_LINEAR_MIPMAP_LINEAR);
...
*/
    //		Texture coordinate of texture unit 0 (vec4) gl_MultiTexCoord0
    //      Texture coordinate of texture unit 1 (vec4) gl_MultiTexCoord1
